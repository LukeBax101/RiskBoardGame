...
def clearAll():
    global alaska,greenLand,NWTerritory,alberta,orlando,qubec,WUS,EUS,CAmerica,venezuela,peru,brazil,argentina,iceland,gb,scandinavia,northEurope,southEurope,westEurope,northAfrica,congo,egypt,eastAfrica,southAfrica,russia,afghanistan,ural,serbia,middleEast,india,madagascar,madagascarLabel,yakutsk,irkutsk,kamchatka,mongolia,china,siam,indonesia,newGuinea,westernAus,easternAus,japan,japanLabel,fillerLabel,attackLabel,defendlabel,playerTurnLabel,endGo,instructionsButton,mapButton,noOfCardsButton,noOfTroopsLabel
    alaska.pack_forget()
    greenLand.pack_forget()
    NWTerritory.pack_forget()
    alberta.pack_forget()
    orlando.pack_forget()
    qubec.pack_forget()
    WUS.pack_forget()
    EUS.pack_forget()
    CAmerica.pack_forget()
    venezuela.pack_forget()
    peru.pack_forget()
    brazil.pack_forget()
    argentina.pack_forget()
    iceland.pack_forget()
    gb.pack_forget()
    scandinavia.pack_forget()
    northEurope.pack_forget()
    southEurope.pack_forget()
    westEurope.pack_forget()
    northAfrica.pack_forget()
    congo.pack_forget()
    egypt.pack_forget()
    eastAfrica.pack_forget()
    southAfrica.pack_forget()
    russia.pack_forget()
    afghanistan.pack_forget()
    ural.pack_forget()
    serbia.pack_forget()
    middleEast.pack_forget()
    india.pack_forget()
    madagascar.pack_forget()
    madagascarLabel.pack_forget()
    yakutsk.pack_forget()
    irkutsk.pack_forget()
    kamchatka.pack_forget()
    mongolia.pack_forget()
    china.pack_forget()
    siam.pack_forget()
    indonesia.pack_forget()
    newGuinea.pack_forget()
    westernAus.pack_forget()
    easternAus.pack_forget()
    japan.place_forget()
    japanLabel.place_forget()
    fillerLabel.pack_forget()
    attackLabel.grid_forget()
    defendlabel.grid_forget()
    playerTurnLabel.grid_forget()
    endGo.grid_forget()
    instructionsButton.grid_forget()
    mapButton.grid_forget()
    noOfCardsButton.grid_forget()
    noOfTroopsLabel.grid_forget()
...
def battleResult(a,d):
    global attackLabel,defendlabel
...
def buildTopFrame(x):
    global players,playerTurnLabel,endGo,instructionsButton,mapButton
...
alaska = Label(main)
greenLand = Label(main)
NWTerritory = Label(main)
alberta = Label(main)
orlando = Label(main)
qubec = Label(main)
WUS = Label(main)
EUS = Label(main)
CAmerica = Label(main)
venezuela = Label(main)
peru = Label(main)
brazil = Label(main)
argentina = Label(main)
iceland = Label(main)
gb = Label(main)
scandinavia = Label(main)
northEurope = Label(main)
southEurope = Label(main)
westEurope = Label(main)
northAfrica = Label(main)
congo = Label(main)
egypt = Label(main)
eastAfrica = Label(main)
southAfrica = Label(main)
russia = Label(main)
afghanistan = Label(main)
ural = Label(main)
serbia = Label(main)
middleEast = Label(main)
india = Label(main)
madagascar = Label(main)
madagascarLabel = Label(main)
yakutsk = Label(main)
irkutsk = Label(main)
kamchatka = Label(main)
mongolia = Label(main)
china = Label(main)
siam = Label(main)
indonesia = Label(main)
newGuinea = Label(main)
westernAus = Label(main)
easternAus = Label(main)
japan = Label(main)
japanLabel = Label(main)
fillerLabel = Label(main)
attackLabel = Label(main)
defendlabel = Label(main)
playerTurnLabel = Label(main)
endGo = Label(main)
instructionsButton = Label(main)
mapButton = Label(main)
noOfCardsButton = Label(main)
noOfTroopsLabel = Label(main)
...
alaska,greenLand,NWTerritory,alberta,orlando,qubec,WUS,EUS,CAmerica,venezuela,peru,brazil,argentina,iceland,gb,scandinavia,northEurope,southEurope,westEurope,northAfrica,congo,egypt,eastAfrica,southAfrica,russia,afghanistan,ural,serbia,middleEast,india,madagascar,madagascarLabel,yakutsk,irkutsk,kamchatka,mongolia,china,siam,indonesia,newGuinea,westernAus,easternAus,japan,japanLabel,fillerLabel,attackLabel,defendlabel,playerTurnLabel,endGo,instructionsButton,mapButton,noOfCardsButton,noOfTroopsLabel
...
def buildMap():
    global players, countries,alaska,greenLand,NWTerritory,alberta,orlando,qubec,WUS,EUS,CAmerica,venezuela,peru,brazil,argentina,iceland,gb,scandinavia,northEurope,southEurope,westEurope,northAfrica,congo,egypt,eastAfrica,southAfrica,russia,afghanistan,ural,serbia,middleEast,india,madagascar,madagascarLabel,yakutsk,irkutsk,kamchatka,mongolia,china,siam,indonesia,newGuinea,westernAus,easternAus,japan,japanLabel,fillerLabel
    countryColours = [[],[]]
    for n in range(42):
        if countries[n][1] == 0:
            colour = players[0][0]
